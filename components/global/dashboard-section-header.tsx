...
export default function DashbaordSectionHeader() {
  ...
  const heading = pathname.replaceAll("/", "").replaceAll("-", " ");
  return (
    <div className="p-4 flex bg-white border-b border-gray-200 shadow-sm items-center">
      ...
      <div className="flex items-center gap-2 flex-1">
        ...
        <h2 className="capitalize text-2xl text-blue-600 font-semibold">
      ...
      <div className="flex pr-8 gap-2 items-center">
        ...
        <div>
          <p className="font-semibold text-blue-600">Mudassir Khan</p>
